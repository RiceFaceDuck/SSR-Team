  ...
  return (
    <div className="p-3 space-y-2 bg-white">
      ...
      {player.appliedCard ? (
        ...
        >
          ...
          <div className="flex flex-col items-start z-10 flex-1 overflow-hidden">
            <span className="text-[13px] font-black text-purple-800 tracking-wide truncate w-full text-left">
              {player.appliedCard.name}
            </span>
            <span className="text-[9px] text-purple-600 font-semibold truncate w-full text-left">
              {player.appliedCard.description}
            </span>
          </div>
      ...
      >
        ...
        <span className="text-[9px] text-red-500 font-semibold bg-red-100 px-1.5 py-0.5 rounded">
          +{player.price}m
        </span>
      </button>
    </div>

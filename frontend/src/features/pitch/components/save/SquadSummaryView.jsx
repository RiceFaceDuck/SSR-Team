    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="flex justify-between items-center py-2 border-b border-slate-100">
          ...
          <span
            className={`font-bold ${isSquadComplete ? 'text-emerald-600' : 'text-amber-500'} bg-slate-100 px-3 py-1 rounded-lg flex items-center gap-1`}
          >
            {startersCount}/11
      ...
      {!isSquadComplete && (
        <div className="bg-amber-50 border border-amber-200 text-amber-700 text-xs p-3 rounded-xl flex items-start gap-2">
          ...
          <p>
            ทีมยังไม่ครบ 11 คน (และผู้จัดการทีม) คุณสามารถบันทึกฉบับร่างไว้ได้
            แต่อาจไม่ได้รับคะแนนในการแข่งขันจริง
          </p>
        </div>
      )}

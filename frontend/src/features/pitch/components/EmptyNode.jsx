...
const EmptyNode = ({ expectedPosition, isBench }) => {
  const topGradient = isBench ? 'from-[#334155] to-[#1e293b]' : 'from-[#0f284e] to-[#0a192f]';
  const bottomGradient = isBench ? 'from-[#1e293b] to-[#0f172a]' : 'from-[#1e3a8a] to-[#0f284e]';
  const borderClass = isBench ? 'border-[#475569]' : 'border-[#3b82f6]/40';
  ...
  return (
    <div className="flex flex-col items-center justify-end w-[48px] sm:w-[55px] lg:w-[65px] cursor-pointer transition-all duration-300 group">
      ...
      <div className="relative w-full h-10 sm:h-12 lg:h-14 flex justify-center items-end mb-[1px]">
        <div
          className={`w-full h-10 sm:h-12 lg:h-14 bg-gradient-to-br ${topGradient} rounded-t-md border border-b-0 ${borderClass} shadow-inner flex flex-col items-center justify-center overflow-hidden group-hover:border-[#fbbf24] transition-colors relative`}
        >
      ...
      <div
        className={`w-full bg-gradient-to-b ${bottomGradient} rounded-b-md shadow-md overflow-hidden flex flex-col z-10 transition-colors border ${borderClass} group-hover:border-[#fbbf24]`}
      >
        ...
        <div
          className={`flex justify-center items-center h-3.5 sm:h-4 w-full border-t ${borderClass}`}
        >

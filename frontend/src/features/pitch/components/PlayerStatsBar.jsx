      ...
      <div className="flex flex-row justify-center items-end gap-1.5 sm:gap-2 bg-white/95 backdrop-blur-sm border border-slate-300 rounded-t-md px-1.5 py-0.5 shadow-sm min-h-[16px] sm:min-h-[18px]">
        {goals > 0 && (
          <div className="flex flex-col items-center justify-end">
            ...
            <span className="text-[6px] sm:text-[8px] font-black text-slate-800 leading-none mt-0.5">
              {goals}
            </span>
          </div>
        )}
        ...
        {yellowCards > 0 && (
          <div className="flex flex-col items-center justify-end">
            ...
            <span className="text-[6px] sm:text-[8px] font-black text-slate-800 leading-none">
              {yellowCards}
            </span>
          </div>
        )}

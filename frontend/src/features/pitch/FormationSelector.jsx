...
const FormationSelector = ({ manager, formation, onChangeFormation }) => {
  ...
  const formationsList =
    manager?.effectLogic?.type === 'UNLOCK_FORMATION' &&
    Array.isArray(manager.effectLogic.formations)
      ? [
          '4-3-3',
          '4-4-2',
          '3-5-2',
          ...
          '5-3-2',
          '5-4-1',
          ...manager.effectLogic.formations,
        ]
  ...
  return (
    <div className="absolute bottom-[125px] sm:bottom-[145px] lg:bottom-[160px] right-2 z-30">
      ...
      >
        <span className="text-[7px] font-bold tracking-wider opacity-80 leading-none mt-0.5">
          FORMATION
        </span>

            ...
            {modalType === 'create' && (
              <div className="space-y-4">
                ...
                <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 space-y-3">
                  <h4 className="text-xs font-bold text-slate-600 border-b border-slate-200 pb-1">
                    ตั้งค่ากติกาพิเศษ (Custom Rules)
                  </h4>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCustomRules({ ...customRules, goal: Number(e.target.value) })
                      }
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCustomRules({ ...customRules, assist: Number(e.target.value) })
                      }
                      className="w-16 bg-white border border-slate-300 rounded text-xs px-2 py-1 text-right"
                    />
                  </div>

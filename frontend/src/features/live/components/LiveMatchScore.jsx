    ...
    <div className="flex justify-between items-center relative z-10 p-2 md:p-4">
      <div className="flex flex-col items-center w-28 shrink-0">
        {match.homeTeam?.logo ? (
          ...
          <div className="w-16 h-16 bg-slate-100 rounded-full mb-2 flex items-center justify-center text-sm font-bold text-slate-400">
            {match.homeTeam?.code}
          </div>
        )}
        <span className="font-bold text-[13px] md:text-sm line-clamp-2 text-center leading-tight">

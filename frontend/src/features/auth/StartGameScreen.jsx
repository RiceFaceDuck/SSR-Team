  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-1/4 z-20 flex flex-col items-center">
        <h1
          className={`text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-white drop-shadow-[0_0_20px_rgba(255,255,255,0.8)] transition-opacity duration-1000 ${showPulse ? 'opacity-100 scale-105' : 'opacity-70 scale-100'} tracking-wider uppercase`}
        >
          TAP TO START
        </h1>
        <p
          className={`mt-4 text-sm md:text-base text-blue-200 font-bold tracking-[0.2em] transition-opacity duration-700 ${showPulse ? 'opacity-100' : 'opacity-40'}`}
        >

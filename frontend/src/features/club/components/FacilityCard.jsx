      ...
      <div className="flex items-center gap-4 relative z-10">
        ...
        <div className="flex-1">
          ...
          <div className="flex justify-between items-center mb-2">
            ...
            <div
              className={`text-xs font-black px-2.5 py-1 rounded-lg shadow-sm border ${isMax ? 'bg-amber-50 border-amber-100 text-amber-600' : 'bg-slate-50 border-slate-100 text-slate-600'}`}
            >
              Lv. {level}
              {isMax && ' (MAX)'}
            </div>
          ...
          {!isMax && (
            <div className="flex items-center justify-between mt-1">
              <div className="text-xs font-semibold text-slate-500">
                ...
                <span
                  className={
                    canAfford ? 'text-indigo-600 font-bold ml-1' : 'text-rose-500 font-bold ml-1'
                  }
                >
                  {cost} EXP
                </span>
              ...
              >
                {!canAfford ? (
                  ...
                  <ArrowUpCircle size={14} className="drop-shadow-sm" />
                )}

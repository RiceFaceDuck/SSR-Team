...
export default function ClubHeader({ totalLevels, availableExp, onClose }) {
  ...
  if (totalLevels >= 45) {
    ...
    clubImage =
      'https://images.unsplash.com/photo-1508344928928-7165b67de128?auto=format&fit=crop&q=80&w=1000';
    tierColor = 'from-fuchsia-500 via-purple-500 to-indigo-600';
    glowColor = 'shadow-purple-500/50';
  } else if (totalLevels >= 15) {
    tierName = 'Professional Team';
    clubImage =
      'https://images.unsplash.com/photo-1577223625816-7546f13df25d?auto=format&fit=crop&q=80&w=1000';
    ...
    <div className="flex-shrink-0 flex flex-col">
      ...
      <div className="relative h-56 sm:h-64 w-full overflow-hidden">
        ...
        <div className="absolute bottom-6 left-6 right-6">
          <div
            className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-gradient-to-r ${tierColor} text-white text-[10px] font-black uppercase tracking-widest mb-3 shadow-[0_0_15px_rgba(0,0,0,0.5)] ${glowColor}`}
          >
            <Sparkles size={12} className="animate-pulse" />
            {tierName}
          </div>
          <h3 className="text-3xl sm:text-4xl font-black text-white italic drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)] tracking-tight">
            MY CLUB
          </h3>
          <div className="flex items-center gap-4 mt-2">
            <div className="text-slate-200 text-sm font-medium flex items-center gap-2 bg-black/40 backdrop-blur-sm px-3 py-1.5 rounded-lg border border-white/10 shadow-inner">
              ...
              Total Lvl: <span className="text-white font-bold text-base">{totalLevels}</span>

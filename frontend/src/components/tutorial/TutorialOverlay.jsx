  ...
  return (
    <div className="fixed inset-0 z-[9999] pointer-events-none">
      ...
      >
        ...
        <h3 className="text-xl font-bold text-[#3b82f6] pr-6 mb-2">{currentStepData.title}</h3>
        <p className="text-gray-300 text-sm leading-relaxed mb-6">{currentStepData.content}</p>

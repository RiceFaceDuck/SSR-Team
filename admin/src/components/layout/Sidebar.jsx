    ...
    <aside className="w-64 bg-slate-900 text-slate-300 h-screen sticky top-0 flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.3)] z-20 transition-all duration-300">
              ...
              {group.items.map((link) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`relative flex items-center justify-center transition-transform duration-300 ${isActive ? 'scale-110' : 'group-hover:scale-110'}`}
                    >
                      <Icon
                        size={18}
                    ...
                    <span
                      className={`font-medium text-sm relative z-10 transition-colors ${isActive ? 'text-blue-100 font-semibold' : ''}`}
                    >
                      {link.title}
                    </span>
      ...
      <div className="p-4 border-t border-slate-800 bg-slate-900/80 backdrop-blur-sm">
        ...
        >
          <LogOut
            size={18}
            className="group-hover:text-red-400 transition-colors group-hover:scale-110 duration-300"
          />

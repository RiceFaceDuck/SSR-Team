...
export const downloadPlayerTemplate = () => {
  try {
    ...
    const instructionsData = [
      ...
      [
        'SKU',
        'รหัสประจำตัวนักเตะ (ไม่ซ้ำกัน)',
        'PLY-001 หรือ API-123',
        'หากปล่อยว่าง ระบบจะสุ่มสร้างให้ แต่แนะนำให้ใส่เพื่อเชื่อม API ได้แม่นยำ',
      ],
      [
        'Name',
        'ชื่อที่ใช้แสดงผลในเกม',
        'Lionel Messi',
        'ควรใช้ชื่อย่อหรือชื่อที่อ่านง่าย (ห้ามเว้นว่าง)',
      ],
      ...
      ['Price', 'ราคานักเตะเริ่มต้น', '12.5 หรือ 5', 'ใส่เฉพาะตัวเลข ห้ามใส่ตัวอักษร (m)'],
      [
        'Status',
        'สถานะปัจจุบัน',
        'active, injured, suspended',
        'ถ้าไม่ใส่ ระบบจะตั้งเป็น active ทันที',
      ],
      [''],
    ...
    const instCols = [{ wch: 15 }, { wch: 35 }, { wch: 25 }, { wch: 60 }];
